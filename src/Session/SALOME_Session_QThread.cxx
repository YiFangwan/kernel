...
//=============================================================================
  ...
  SALOME_Session_QThread* SALOME_Session_QThread::Instance(int argc, char ** argv, QMutex *theGUIMutex)
{
  if (_singleton == 0) _singleton = new SALOME_Session_QThread(argc, argv, theGUIMutex);
  return _singleton;
